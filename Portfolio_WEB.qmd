...
Dessa forma, Newton concluiu sua equação clássica
...
O semieixo maior $a$ é a definição do tamanho da órbita, mostrado na (@fig-semieixomaior). Ele é a metade da distância do periastro (ponto mais próximo) e o apogeu (ponto mais distante).
...
$$
e = |\frac{1}{\mu}[(v^2 - \frac{\mu}{r})r - (r \cdot v)v]|
$$
...
Também conhecido como Big omega, ele é o ângulo do equinócio vernal no plano equatorial até o ponto onde o corpo orbitador cruza o equador em direção ao Norte (nodo ascendente), como mostra a (@fig-bigomega). Ou seja, dado um plano referencial fixo, o plano orbital gira na orientação do plano referencial, o que é medido por esse parâmetro.
...
O argumento do perigeu, ou omega, é o ângulo no plano orbital, do nodo ascendente até o ponto de maior aproximação do corpo central, o periastro. Pode ser observado na (@fig-omega). Ou seja, é o ângulo que mede o movimento da órbita ao girar em torno do plano orbital.
...
É o ângulo que mede a posição real do satélite, medido do foco da elipse (corpo central), entre o ponto do periastro até a posição do corpo que orbita. Como mostrado na (@fig-anomaliaverdadeira). Ou seja, dado ponto de início $0 \degree$, a anomalia verdadeira é o ângulo que mede a posição em relação ao início, que é dado pelo $\omega$.
...
$$
tan(\frac{E}{2}) = \sqrt{\frac{1-e}{1+e}} tan(\frac{nu}{2})
$$
