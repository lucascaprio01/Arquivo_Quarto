...
## 5.1 Elementos Orbitais Clássicos
...
- Anomalia Verdadeira ($ν$) ou Anomalia Média ($M_0$ para um tempo $T_0$)
...
O semieixo maior $a$ é a definição do tamanho da órbita, mostrado na (@fig-semieixomaior)

![Semieixo maior $a$.](Imagens/Semieixo%20maior.jpg){width=50% #fig-semieixomaior}

### Excentricidade $e$

Como já comentado tópicos atrás, a excentricidade $e$ define o formato da órbita, no caso específico das órbitas fechadas, quanto mais próximo de 0 o valor de $e$, a órbita tende a um círculo, e quanto mais próximo de 1, a órbita degenera para uma elipse. Como mostrado na (@fig-excentricidade)

![Excentricidade.](Imagens/Excentricidade.jpg){#fig-excentricidade}

### Inclinação $i$

É o angulo entre o plano equatorial e o plano orbital, representado na (@fig-inclinação)

![Inclinação.](Imagens/Inclina%C3%A7%C3%A3o.jpg){width=50% #fig-inclinação}

### Ascensão Reta do Nodo Ascendente $Ω$

Também conhecido como Big omega, ele é o ângulo do equinócio vernal no plano equatorial até o ponto onde o corpo orbitador cruza o equador em direção ao Norte (nodo ascendente), como mostra a (@fig-bigomega)

![Ascensão Reta do Nodo Ascendente $\Omega$.](Imagens/Big%20Omega.jpg){width=50% #fig-bigomega}

### Argumento do Perigeu $ω$

O argumento do perigeu, ou omega, é o ângulo no plano orbital, do nodo ascendente até o ponto de maior aproximação do corpo central, o periastro. Pode ser observado na (@fig-omega)

![Argumento do Perigeu $\omega$.](Imagens/Omega.jpg){width=50% #fig-omega}

### Anomalia Verdadeira $ν$

É o ângulo que mede a posição real do satélite, medido do foco da elipse (corpo central), entre o ponto do periastro até a posição do corpo que orbita. Como mostrado na (@fig-anomaliaverdadeira)

![Anomalia Verdadeira $\nu$.](Imagens/Anomalia%20Verdadeira.jpg){width=50% #fig-anomaliaverdadeira}

### Anomalia Média $M$

É uma medida angular que representa uma fração de deslocamento do astro que orbita, desde sua ultima passagem pelo periastro, ou seja, é como se fosse a Anomalia verdadeira, mas assumindo uma velocidade angular constante.
